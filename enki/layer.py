...
class _ILayer(abc.ABC):
    ...
    В данном игровое плагине чётко разделяется на 1) сетевой функционал сетевого
    ...
    находиться в другом потоке, процессе или компьютере.
    """
    pass
...
def init(net_layer: INetLayer, game_layer: IGameLayer):
    ...
    в рантайме, а в связьях объектов иначе будут циклы.
    """
