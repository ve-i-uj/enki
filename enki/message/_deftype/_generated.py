...
UINT8_SPEC = _deftype.DataTypeSpec(
    id=1,
...
UINT16_SPEC = _deftype.DataTypeSpec(
    id=2,
...
DBID_SPEC = _deftype.DataTypeSpec(
    id=3,
...
UINT32_SPEC = _deftype.DataTypeSpec(
    id=4,
...
INT8_SPEC = _deftype.DataTypeSpec(
    id=5,
    base_type_name='INT8',
    name='INT8',    
...
INT16_SPEC = _deftype.DataTypeSpec(
    id=6,
...
AVATAR_UID_SPEC = _deftype.DataTypeSpec(
    id=7,
...
INT64_SPEC = _deftype.DataTypeSpec(
    id=8,
...
STRING_SPEC = _deftype.DataTypeSpec(
    id=9,
...
AVATAR_NAME_SPEC = _deftype.DataTypeSpec(
    id=10,
...
FLOAT_SPEC = _deftype.DataTypeSpec(
    id=11,
...
DOUBLE_SPEC = _deftype.DataTypeSpec(
    id=12,
...
PYTHON_SPEC = _deftype.DataTypeSpec(
    id=13,
...
PY_DICT_SPEC = _deftype.DataTypeSpec(
    id=14,
...
PY_TUPLE_SPEC = _deftype.DataTypeSpec(
    id=15,
...
PY_LIST_SPEC = _deftype.DataTypeSpec(
    id=16,
...
ENTITYCALL_SPEC = _deftype.DataTypeSpec(
    id=17,
...
BLOB_SPEC = _deftype.DataTypeSpec(
    id=18,
    base_type_name='BLOB',
    name='BLOB',    
...
VECTOR2_SPEC = _deftype.DataTypeSpec(
    id=19,
...
VECTOR3_SPEC = _deftype.DataTypeSpec(
    id=20,
...
VECTOR4_SPEC = _deftype.DataTypeSpec(
    id=21,
...
AVATAR_INFO_SPEC = _deftype.DataTypeSpec(
    id=22,
...
AVATAR_INFO_LIST_SPEC = _deftype.DataTypeSpec(
    id=23,
...
ARRAY_25_SPEC = _deftype.DataTypeSpec(
    id=25,
    base_type_name='ARRAY',
    name='ARRAY_25',    
...
AVATAR_DBIDS_SPEC = _deftype.DataTypeSpec(
    id=24,
    base_type_name='FIXED_DICT',
    name='AVATAR_DBIDS',    
    module_name='',
...
NESTED_FIXED_DICT_SPEC = _deftype.DataTypeSpec(
    id=26,
    base_type_name='FIXED_DICT',
...
ARRAY_27_SPEC = _deftype.DataTypeSpec(
    id=27,
    base_type_name='ARRAY',
    name='ARRAY_27',    
