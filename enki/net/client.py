...
from enki.core.message import IMessage, Message, IMsgReceiver, MsgDescr
from enki.net.connection import IDataReceiver, ConnectResult, AppConnection
...
class TCPClient(IClient, IDataReceiver):
    """TCPClient of a KBEngine server."""
