...
from enki import settings, enkitype
...
from enki.net.kbeclient import Client, Message, MsgDescr, MessageSerializer
...
class LoginBaseappCommand(_base.Command):
    ...
    def __init__(self, client: Client, account_name: str, password: str):
        super().__init__(client)
...
class ReqAccountNewPasswordCommand(_base.Command):
    ...
    def __init__(self, client: Client, entity_id: int, old_pwd: str, new_pwd: str):
        super().__init__(client)
        self._entity_id = entity_id
...
class LogoutBaseappCommand(_base.Command):
    ...
    def __init__(self, client: Client, rnd_uuid: int, entity_id: int):
        super().__init__(client)
        self._rnd_uuid = rnd_uuid
        self._entity_id = entity_id
...
class OnUpdateDataFromClientCommand(_base.Command):
    ...
    def __init__(self, client: Client, position: Position,
...
class OnUpdateDataFromClientForControlledEntityCommand(_base.Command):
    ...
    def __init__(self, client: Client, entity_id: int,
...
class ForwardEntityMessageToCellappFromClientCommand(_base.Command):
    ...
    def __init__(self, client: Client, entity_id: int, msgs: list[Message]):
        super().__init__(client)
        self._entity_id = entity_id
        self._msgs = msgs
...
class ReqAccountBindEmailCommand(_base.Command):
    ...
    def __init__(self, client: Client, entity_id: int, password: str, email: str):
        super().__init__(client)
        self._entity_id = entity_id
        self._password = password
        self._email = email
