...
from enki.net.kbeclient.message import Message, IMessage
from enki.net.kbeclient.kbetype import Direction, Position
...
class _EntityRemoteCall:
    ...
    def __str__(self) -> str:
        return f'{self.__class__.__name__}(entity_id={self._entity.id})'
