...
class EntityHelper:
    ...
    # TODO: [2025-09-04 18:25 burov_alexey@mail.ru]:
    # Эта логика должна сместиться в приложение. И приложение в зависимости от
    # своего состояния уже принимает решение, каким обработчиком парсить.
    @property
    ...
    def get_entity_cls_name_by_eid(self, entity_id: int) -> str | None:
