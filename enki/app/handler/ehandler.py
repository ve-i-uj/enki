...
from enki import settings, devonly, kbemath
...
class _OnEntityCreatedMixin:
    ...
    @property
    def _entity_helper(self) -> EntityHelper:
        return None
...
class EntityHandlerResult(base.HandlerResult):
    @property
    def result(self) -> EntityParsedData:
        return None
...
class _OnUpdateData_XYZ_YPR_BaseHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> _OnUpdateData_XYZ_YPR_BaseParsedData:
        return None
...
class _OnUpdateData_XYZ_YPR_BaseHandler(EntityHandler, _OptimizedHandlerMixin):
    @property
    def _parsed_data_cls(self) -> ClassVar[Type[_OnUpdateData_XYZ_YPR_BaseParsedData]]:
        return None

    @property
    def _handler_result_cls(self) -> ClassVar[Type[_OnUpdateData_XYZ_YPR_BaseHandlerResult]]:
        return None
...
class OnUpdatePropertysParsedData(base.ParsedMsgData):
    ...
    @property
    def e_properties(self) -> Dict[str, Any]:
        return None

    @property
    def ec_properties(self) -> Dict[str, Any]:
        return None
...
class OnUpdatePropertysHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnUpdatePropertysParsedData:
        return None
...
class OnUpdatePropertysHandler(EntityHandler):
    ...
    def handle(self, msg: Message) -> OnUpdatePropertysHandlerResult:
        ...
        if not self._entity_helper.get_entity_cls_name_by_eid(entity_id):
            self._entity_helper.add_pending_msg(entity_id, msg)
            return OnUpdatePropertysHandlerResult(
                success=False,
                result=OnUpdatePropertysParsedData(settings.NO_ENTITY_ID, {}),
                text=_SAVE_MSG_TEMPL.format(entity_id=entity_id)
            )
...
class OnCreatedProxiesHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnCreatedProxiesParsedData:
        return None
...
class OnRemoteMethodCallHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnRemoteMethodCallParsedData:
        return None
...
class OnRemoteMethodCallOptimizedHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnRemoteMethodCallOptimizedParsedData:
        return None
...
class OnEntityDestroyedHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnEntityDestroyedParsedData:
        return None
...
class OnEntityEnterWorldHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnEntityEnterWorldParsedData:
        return None
...
class OnEntityLeaveWorldHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnEntityLeaveWorldParsedData:
        return None
...
class OnEntityLeaveWorldOptimizedHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnEntityLeaveWorldOptimizedParsedData:
        return None
...
class OnSetEntityPosAndDirHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnSetEntityPosAndDirParsedData:
        return None
...
class OnEntityEnterSpaceHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnEntityEnterSpaceParsedData:
        return None
...
class OnEntityLeaveSpaceHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnEntityLeaveSpaceParsedData:
        return None
...
class OnUpdateBasePosHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnUpdateBasePosParsedData:
        return None
...
class OnUpdateBaseDirHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnUpdateBaseDirParsedData:
        return None
...
class OnUpdateBasePosXZHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnUpdateBasePosXZParsedData:
        return None
...
class OnUpdateDataHandlerResult(base.HandlerResult):
    @property
    def result(self) -> OnUpdateDataParsedData:
        return None
...
class OnUpdateData_XZ_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_ParsedData:
        return None
...
class OnUpdateData_YPR_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_YPR_ParsedData:
        return None
...
class OnUpdateData_YP_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_YP_ParsedData:
        return None
...
class OnUpdateData_YR_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_YR_ParsedData:
        return None
...
class OnUpdateData_PR_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_PR_ParsedData:
        return None
...
class OnUpdateData_Y_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_Y_ParsedData:
        return None
...
class OnUpdateData_P_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_P_ParsedData:
        return None
...
class OnUpdateData_R_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_R_ParsedData:
        return None
...
class OnUpdateData_XZ_YPR_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_YPR_ParsedData:
        return None
...
class OnUpdateData_XZ_YP_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_YP_ParsedData:
        return None
...
class OnUpdateData_XZ_YR_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_YR_ParsedData:
        return None
...
class OnUpdateData_XZ_PR_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_PR_ParsedData:
        return None
...
class OnUpdateData_XZ_Y_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_Y_ParsedData:
        return None
...
class OnUpdateData_XZ_P_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_P_ParsedData:
        return None
...
class OnUpdateData_XZ_R_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_R_ParsedData:
        return None
...
class OnUpdateData_XYZ_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_ParsedData:
        return None
...
class OnUpdateData_XYZ_YPR_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_YPR_ParsedData:
        return None
...
class OnUpdateData_XYZ_YP_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_YP_ParsedData:
        return None
...
class OnUpdateData_XYZ_YR_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_YR_ParsedData:
        return None
...
class OnUpdateData_XYZ_PR_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_PR_ParsedData:
        return None
...
class OnUpdateData_XYZ_Y_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_Y_ParsedData:
        return None
...
class OnUpdateData_XYZ_P_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_P_ParsedData:
        return None
...
class OnUpdateData_XYZ_R_HandlerResult(_OnUpdateData_XYZ_YPR_BaseHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_R_ParsedData:
        return None
...
class OnUpdateData_Y_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_Y_OptimizedParsedData:
        return None
...
class OnUpdateData_R_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_R_OptimizedParsedData:
        return None
...
class OnUpdateData_P_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_P_OptimizedParsedData:
        return None
...
class OnUpdateData_YP_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_YP_OptimizedParsedData:
        return None
...
class OnUpdateData_YR_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_YR_OptimizedParsedData:
        return None
...
class OnUpdateData_PR_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_PR_OptimizedParsedData:
        return None
...
class OnUpdateData_YPR_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_YPR_OptimizedParsedData:
        return None
...
class OnUpdateData_XZ_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_OptimizedParsedData:
        return None
...
class OnUpdateData_XZ_YPR_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_YPR_OptimizedParsedData:
        return None
...
class OnUpdateData_XZ_YP_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_YP_OptimizedParsedData:
        return None
...
class OnUpdateData_XZ_YR_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_YR_OptimizedParsedData:
        return None
...
class OnUpdateData_XZ_PR_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_PR_OptimizedParsedData:
        return None
...
class OnUpdateData_XZ_Y_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_Y_OptimizedParsedData:
        return None
...
class OnUpdateData_XZ_P_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_P_OptimizedParsedData:
        return None
...
class OnUpdateData_XZ_R_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XZ_R_OptimizedParsedData:
        return None
...
class OnUpdateData_XYZ_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_OptimizedParsedData:
        return None
...
class OnUpdateData_XYZ_YPR_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_YPR_OptimizedParsedData:
        return None
...
class OnUpdateData_XYZ_YP_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_YP_OptimizedParsedData:
        return None
...
class OnUpdateData_XYZ_YR_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_YR_OptimizedParsedData:
        return None
...
class OnUpdateData_XYZ_PR_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_PR_OptimizedParsedData:
        return None
...
class OnUpdateData_XYZ_Y_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_Y_OptimizedParsedData:
        return None
...
class OnUpdateData_XYZ_P_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_P_OptimizedParsedData:
        return None
...
class OnUpdateData_XYZ_R_OptimizedHandlerResult(EntityHandlerResult):
    @property
    def result(self) -> OnUpdateData_XYZ_R_OptimizedParsedData:
        return None
...
class OnControlEntityHandlerResult(base.HandlerResult):
    ...
    @property
    def result(self) -> OnControlEntityParsedData:
        return None
