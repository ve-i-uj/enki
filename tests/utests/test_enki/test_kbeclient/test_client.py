"""Tests of the module client.client ."""
...
class OnReceiveDataTestCase(unittest.TestCase):
    """Tests for the 'TCPClient.on_receive_data' method"""

    def setUp(self) -> None:
        super().setUp()
        login_app_addr = Addr('0.0.0.0', 20013)
    ...
    def test_chunk_511_512_511_504_511_506_511_507_511_511_506_506_65_12_509(self):
        ...
        for data in (data_1, data_2, data_3, data_4, data_5):
            self._client._on_receive_data(memoryview(data))
