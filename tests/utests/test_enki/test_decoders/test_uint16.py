...
class TestUINT16DecoderBoundaries:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (b"\x7f\xff", 32767),  # Максимальное положительное если бы было int16
            (b"\x00\x01", 1),  # Минимальное положительное ненулевое
            (b"\xff\xfe", 65534),  # Максимальное -1
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (KBEUInt16(32768), b"\x80\x00"),  # Граница положительных/отрицательных
            (KBEUInt16(1), b"\x00\x01"),  # Минимальное ненулевое
            (KBEUInt16(65534), b"\xff\xfe"),  # Максимальное -1
        ],
    )
