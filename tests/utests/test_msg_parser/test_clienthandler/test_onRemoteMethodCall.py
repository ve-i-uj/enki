...
class OnRemoteMethodCallHandlerTestCase(EnkiBaseTestCase):
    ...
    def test_ok(self):
        ...
        msg_506, data_tail = MessageEncoder(msgspec.app.client.SPEC_BY_ID).deserialize(memoryview(data))
    ...
    def test_component(self):
        ...
        msg_506, data = MessageEncoder(msgspec.app.client.SPEC_BY_ID).deserialize(memoryview(data))
        assert msg_506 is not None, 'Invalid initial data'
