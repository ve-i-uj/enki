...
from enki.handlers.server_handlers.baseapphandler import OnAppActiveTickHandler, OnBroadcastGlobalDataChangedHandler, OnEntityAutoLoadCBFromDBMgrHandler, \
...
class OnGetEntityAppFromDbmgrTestCase(TestCase):
    ...
    def test_onRegisterNewApp(self):
        ...
        pd = res.result
        assert pd.componentID == 8001
        assert pd.internal_address == Addr(host='172.23.0.10', port=39959)
