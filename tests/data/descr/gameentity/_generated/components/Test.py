...
class _TestBaseRemoteCall(ClientEntityComponentBaseRemoteCall):
...
class _TestCellRemoteCall(ClientEntityComponentCellRemoteCall):
...
class TestBase(ClientGameEntityComponent):
    CLS_ID = 3
