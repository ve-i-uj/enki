...
from enki.net.netentity import BaseEntityRemoteCall, CellEntityRemoteCall, EntityComponentRemoteCall
...
class _AvatarBaseEntityRemoteCall(BaseEntityRemoteCall):
...
class _AvatarCellEntityRemoteCall(CellEntityRemoteCall):
