...
class _GateBaseEntityRemoteCall(netentity.BaseEntityRemoteCall):
...
class _GateCellEntityRemoteCall(netentity.BaseEntityRemoteCall):
...
class GateBase(netentity.Entity):
    CLS_ID = 7
